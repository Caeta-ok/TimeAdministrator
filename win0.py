...
"gridline-color: rgb(40, 40, 40);")
        ...
        self.configurate_selection_frame.setGeometry(QtCore.QRect(610, 19, 589, 433))
...
"gridline-color: rgb(65, 65, 65);")
        ...
        self.min_label_2.setGeometry(QtCore.QRect(256, 396, 19, 16))
        self.min_label_2.setObjectName("min_label_2")
        self.spin_hours_2 = QtWidgets.QSpinBox(self.configurate_selection_frame)
        self.spin_hours_2.setGeometry(QtCore.QRect(209, 372, 36, 22))
        ...
        self.hours_label_3.setGeometry(QtCore.QRect(345, 397, 34, 16))
        self.hours_label_3.setObjectName("hours_label_3")
        self.button_quit_all_acts = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_quit_all_acts.setGeometry(QtCore.QRect(290, 115, 35, 23))
        self.button_quit_all_acts.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_quit_all_acts.setObjectName("button_quit_all_acts")
...
"image: url(:/calendarIcon/calendar2.jpg);")
        ...
        self.min_label_3.setGeometry(QtCore.QRect(389, 397, 19, 16))
        ...
        self.time_label.setGeometry(QtCore.QRect(28, 373, 28, 16))
        self.time_label.setObjectName("time_label")
        self.spin_min_3 = QtWidgets.QSpinBox(self.configurate_selection_frame)
        self.spin_min_3.setGeometry(QtCore.QRect(380, 373, 36, 22))
        self.spin_min_3.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.spin_min_3.setObjectName("spin_min_3")
        self.button_add_all_acts = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_add_all_acts.setGeometry(QtCore.QRect(290, 86, 35, 23))
        self.button_add_all_acts.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_add_all_acts.setObjectName("button_add_all_acts")
        self.spin_sec_2 = QtWidgets.QSpinBox(self.configurate_selection_frame)
        self.spin_sec_2.setGeometry(QtCore.QRect(285, 372, 36, 22))
        ...
        self.all_acts_list.setGeometry(QtCore.QRect(56, 83, 220, 112))
        ...
        self.sec_label_2.setGeometry(QtCore.QRect(293, 397, 22, 16))
        self.sec_label_2.setObjectName("sec_label_2")
        self.spin_hours_3 = QtWidgets.QSpinBox(self.configurate_selection_frame)
        self.spin_hours_3.setGeometry(QtCore.QRect(342, 373, 36, 22))
        ...
        self.spin_sec_3.setGeometry(QtCore.QRect(418, 373, 36, 22))
        ...
        self.spin_min_2.setGeometry(QtCore.QRect(247, 372, 36, 22))
        ...
        self.combo_box_ops_time.setGeometry(QtCore.QRect(61, 373, 135, 20))
        ...
        self.hours_label_2.setGeometry(QtCore.QRect(212, 396, 34, 16))
        self.hours_label_2.setObjectName("hours_label_2")
        self.sec_label_3 = QtWidgets.QLabel(self.configurate_selection_frame)
        self.sec_label_3.setGeometry(QtCore.QRect(426, 398, 22, 16))
        ...
        self.default_button.setGeometry(QtCore.QRect(25, 401, 75, 23))
        ...
        self.activities_show_list.setGeometry(QtCore.QRect(336, 83, 220, 112))
        ...
        self.button_add_acts.setGeometry(QtCore.QRect(290, 144, 35, 23))
        self.button_add_acts.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_add_acts.setObjectName("button_add_acts")
        self.button_quit_acts = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_quit_acts.setGeometry(QtCore.QRect(290, 173, 35, 23))
        self.button_quit_acts.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_quit_acts.setObjectName("button_quit_acts")
        self.people_show_label = QtWidgets.QLabel(self.configurate_selection_frame)
        self.people_show_label.setGeometry(QtCore.QRect(413, 208, 77, 16))
        ...
        self.all_people_label.setGeometry(QtCore.QRect(141, 208, 49, 16))
        self.all_people_label.setObjectName("all_people_label")
        self.button_quit_people = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_quit_people.setGeometry(QtCore.QRect(289, 316, 35, 23))
        self.button_quit_people.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_quit_people.setObjectName("button_quit_people")
        self.button_quit_all_people = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_quit_all_people.setGeometry(QtCore.QRect(289, 258, 35, 23))
        self.button_quit_all_people.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_quit_all_people.setObjectName("button_quit_all_people")
        ...
        self.button_add_people = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_add_people.setGeometry(QtCore.QRect(289, 287, 35, 23))
        self.button_add_people.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_add_people.setObjectName("button_add_people")
        self.people_show_list = QtWidgets.QListView(self.configurate_selection_frame)
        self.people_show_list.setGeometry(QtCore.QRect(335, 226, 220, 112))
        self.people_show_list.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.people_show_list.setObjectName("people_show_list")
        self.button_add_all_people = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_add_all_people.setGeometry(QtCore.QRect(289, 229, 35, 23))
        self.button_add_all_people.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_add_all_people.setObjectName("button_add_all_people")
        self.all_people_list = QtWidgets.QListView(self.configurate_selection_frame)
        self.all_people_list.setGeometry(QtCore.QRect(55, 226, 220, 112))
        self.all_people_list.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.all_people_list.setObjectName("all_people_list")
        self.from_label_2 = QtWidgets.QLabel(self.configurate_selection_frame)
        self.from_label_2.setGeometry(QtCore.QRect(254, 354, 26, 16))
        self.from_label_2.setObjectName("from_label_2")
        self.to_label_2 = QtWidgets.QLabel(self.configurate_selection_frame)
        self.to_label_2.setGeometry(QtCore.QRect(393, 356, 17, 16))
        self.to_label_2.setObjectName("to_label_2")
        self.manage_register_frame = QtWidgets.QFrame(self.tab1)
        self.manage_register_frame.setGeometry(QtCore.QRect(610, 466, 696, 272))
...
"")
    ...
    def retranslateUi(self, win0):
        ...
        self.button_quit_all_acts.setText(_translate("win0", "<-*"))
        ...
        self.button_add_all_acts.setText(_translate("win0", "*->"))
        ...
        self.button_quit_acts.setText(_translate("win0", "<-"))
        self.people_show_label.setText(_translate("win0", "People to Show"))
        self.all_people_label.setText(_translate("win0", "All People"))
        self.button_quit_people.setText(_translate("win0", "<-"))
        self.button_quit_all_people.setText(_translate("win0", "<-*"))
        self.people_label.setText(_translate("win0", "People:"))
        self.button_add_people.setText(_translate("win0", "->"))
        self.button_add_all_people.setText(_translate("win0", "*->"))
