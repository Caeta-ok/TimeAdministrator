...
"gridline-color: rgb(65, 65, 65);")
        ...
        self.button_quit_all_ops = QtWidgets.QPushButton(self.configurate_selection_frame)
        self.button_quit_all_ops.setGeometry(QtCore.QRect(290, 115, 35, 23))
        self.button_quit_all_ops.setStyleSheet("background-color: rgb(65, 65, 65);")
        self.button_quit_all_ops.setObjectName("button_quit_all_ops")
...
"image: url(:/calendarIcon/calendar2.jpg);")
        ...
        self.button_quit_ops.setGeometry(QtCore.QRect(290, 173, 35, 23))
...
"")
    ...
    def retranslateUi(self, win0):
        ...
        self.button_quit_all_ops.setText(_translate("win0", "<-*"))
